...
srcdir = .
topdir = /Users/daiki-kudo/.rbenv/versions/3.1.0/include/ruby-3.1.0
hdrdir = $(topdir)
arch_hdrdir = /Users/daiki-kudo/.rbenv/versions/3.1.0/include/ruby-3.1.0/x86_64-darwin21
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/daiki-kudo/.rbenv/versions/3.1.0
...
DEFS     = 
CPPFLAGS = -DRUBY_EXTCONF_H=\"$(RUBY_EXTCONF_H)\" -I/Users/daiki-kudo/.rbenv/versions/3.1.0/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)
CXXFLAGS = $(CCDLFLAGS) -fdeclspec $(ARCH_FLAG)
ldflags  = -L. -L/Users/daiki-kudo/.rbenv/versions/3.1.0/lib  -fstack-protector-strong -L/usr/local/lib
dldflags = -L/Users/daiki-kudo/.rbenv/versions/3.1.0/lib  -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress 
ARCH_FLAG = 
